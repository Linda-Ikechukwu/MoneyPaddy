...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.budgetView = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n\nvar budgetView = exports.budgetView = function () {\n  //Private function to format numbers\n  var formatNumber = function formatNumber(num) {\n    var numSplit = void 0,\n        integer = void 0,\n        decimal = void 0;\n\n    //Make the number an absolute one i.e remove any sign, fixed to a decimal point of two\n    num = Math.abs(num).toFixed(2); //returns a string\n    //Spilt number into 2 parts, one for interger, the for the decimal part\n    numSplit = num.split('.');\n    //Assign the interger and decimal sides to variables. format integer to add commas\n    integer = parseInt(numSplit[0]).toLocaleString();\n    decimal = numSplit[1];\n    //if type of num is expense return - and the formatted number, else return +, then the formatted number\n    return integer + '.' + decimal;\n  };\n\n  return {\n\n    getInput: function getInput() {\n      //if viewport width is less than 520px, read data from the overlay form instead of the desktop form\n      if (window.innerWidth <= 520) {\n        return {\n          inputType: document.querySelector(_base.domElements.overlayType).value,\n          inputDescription: document.querySelector(_base.domElements.overlayDescription).value,\n          inputValue: parseFloat(document.querySelector(_base.domElements.overlayValue).value)\n        };\n      } else {\n        return {\n          inputType: document.querySelector(_base.domElements.desktopType).value, //will return either 'expense' or 'income'.\n          inputDescription: document.querySelector(_base.domElements.desktopDescription).value,\n          inputValue: parseFloat(document.querySelector(_base.domElements.desktopValue).value)\n        };\n      }\n    },\n\n    //Publicly accessible method which accepts the resulting object; newItem and its type\n    addItemToList: function addItemToList(obj, type) {\n      var listHtml = void 0,\n          newHtml = void 0,\n          element = void 0,\n          sign = void 0;\n      //Create html templates based on each input type i.e income or expenses\n      if (type === 'income') {\n        element = _base.domElements.incomeList;\n        sign = '+';\n        listHtml = '<li id=\"' + obj.id + '\"><span class=\"add_remove\">&times</span><span class=\"add_description\">' + obj.description + '</span><span class=\"add_amount' + sign + ' ' + formatNumber(obj.value, type) + '</span></li>';\n      } else if (type === 'expense') {\n        element = _base.domElements.expenseList;\n        sign = '-';\n        listHtml = '<li id=\"' + obj.id + '\"><span class=\"add_remove\">&times</span><span class=\"add_description\">' + obj.description + '</span><span class=\"add_amount\">' + sign + ' ' + formatNumber(obj.value, type) + '</span><span class=\"add_percentage\">- %per%</span></li>';\n      }\n\n      //Insert newHtml to either an expense list or income list\n      document.querySelector(element).insertAdjacentHTML('beforeend', newHtml);\n    },\n\n    //Function to display the Mobile Form\n    displayMobileForm: function displayMobileForm() {\n      document.querySelector(_base.domElements.overlay).style.visibility = \"visible\";\n      document.querySelector(_base.domElements.overlayForm).style.visibility = \"visible\";\n      document.querySelector(_base.domElements.overlayForm).style.height = \"28rem\";\n    },\n\n    //Function to close the Mobile Form and overlay\n    removeOverlay: function removeOverlay() {\n      document.querySelector(_base.domElements.overlay).style.visibility = \"hidden\";\n      document.querySelector(_base.domElements.overlayForm).style.visibility = \"hidden\";\n      document.querySelector(_base.domElements.overlayForm).style.height = \"0\";\n    },\n\n    //Display or Hide settings panel on click\n    shSettingsBody: function shSettingsBody() {\n      document.querySelector(_base.domElements.settingsBody).classList.remove('hidden');\n      document.querySelector(_base.domElements.settingsBody).classList.toggle('close');\n      document.querySelector(_base.domElements.settingsBody).classList.toggle('open');\n      document.querySelector(_base.domElements.settingsBodyContent).classList.toggle('hidden');\n    },\n\n    clearFormFields: function clearFormFields() {\n      var formFields = [];\n\n      if (window.innerWidth <= 520) {\n        formFields = [document.querySelector(_base.domElements.overlayDescription), document.querySelector(_base.domElements.overlayValue)];\n      } else {\n        formFields = [document.querySelector(_base.domElements.desktopDescription), document.querySelector(_base.domElements.desktopValue)];\n      }\n\n      formFields.forEach(function (current) {\n        current.value = \" \";\n        formFields[1].placeholder = 'Amount';\n      });\n    },\n\n    displayBalance: function displayBalance(obj) {\n      var type = void 0,\n          sign = void 0;\n      obj.balance > 0 ? type = 'income' : type = 'expense';\n      type === 'income' ? sign = '+' : sign = '-';\n\n      document.querySelector(_base.domElements.sign).textContent = sign;\n      document.querySelector(_base.domElements.availableBalance).textContent = formatNumber(obj.balance);\n      document.querySelector(_base.domElements.totalIncome).textContent = formatNumber(obj.totalIncome);\n      document.querySelector(_base.domElements.totalExpense).textContent = formatNumber(obj.totalExpense);\n\n      if (obj.percentage > 0) {\n        document.querySelector(_base.domElements.totalPercentage).textContent = obj.percentage + '%';\n      } else {\n        document.querySelector(_base.domElements.totalPercentage).textContent = '--';\n      }\n    },\n\n    displayPercentages: function displayPercentages(percentages) {\n      var fields = void 0;\n\n      //Select all expense percentages span and convert the nodelist to an array\n      fields = Array.from(document.querySelectorAll(_base.domElements.percentage));\n\n      //Call the nodelistforeaach function to loop through the fields nodestring\n      fields.forEach(function (field, index) {\n        if (percentages[index] > 0) {\n          field.textContent = '- ' + percentages[index] + '%';\n        } else {\n          field.textContent = '--';\n        }\n      });\n    },\n\n    displayDate: function displayDate() {\n      var now = void 0,\n          year = void 0,\n          month = void 0,\n          months = void 0;\n      now = new Date();\n      //get month\n      month = now.getMonth(); //returns an integer of a zero based array representing respective months\n      months = ['January', 'Febuary', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];\n\n      year = now.getFullYear();\n\n      document.querySelector(_base.domElements.date).textContent = months[month] + ', ' + year;\n    },\n\n    deletefromList: function deletefromList(selectorID) {\n      document.getElementById(selectorID).remove();\n    },\n\n    getUserCurrency: function getUserCurrency() {\n      document.querySelector(_base.domElements.userCurrency).innerHTML = document.querySelector(_base.domElements.selectCurrency).value;\n    }\n\n  };\n}();\n\n//# sourceURL=webpack:///./src/js/view.js?");
